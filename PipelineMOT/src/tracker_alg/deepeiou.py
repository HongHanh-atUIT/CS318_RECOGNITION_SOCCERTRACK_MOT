...
class DeepEIoU:
    def __init__(self,
                 ...
                 proximity_thresh: float = 0.5,       # thres về IOU trong stage 1 - distance
                 appearance_thresh: float = 0.25,     # appearance_thresh (đã /2) - distance
                 with_reid: bool = True,
                 use_project = False                  # không có tác dụng, placeholder
                ):
